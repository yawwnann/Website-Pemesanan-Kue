...
<div class="container mx-auto py-16 px-4 md:px-8 grid grid-cols-1 lg:grid-cols-2 gap-8 mt-20">

    <div class="p-8 bg-white rounded-lg shadow-xl hover:shadow-2xl transition duration-300" data-aos="fade-right">
        <h2 class="text-3xl font-bold text-yellow-600 mb-6">Hubungi Kami</h2>
        ...
        <form action="#" class="space-y-6">
            <div class="relative" data-aos="fade-up" data-aos-delay="200">
                <input type="text" name="name" id="name" placeholder=" "
                    class="w-full p-4 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-600 transition duration-200 input-field">
            ...
            <div class="relative" data-aos="fade-up" data-aos-delay="500">
                <select name="inquiry" id="inquiry" required
                    class="w-full p-4 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-600 transition duration-200">
            ...
            <div class="relative" data-aos="fade-up" data-aos-delay="600">
                <textarea name="message" rows="4" placeholder=" " required
                    class="w-full p-4 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-600 transition duration-200 input-field"></textarea>
                <label for="message" class="absolute left-4 top-4 text-gray-500 transition-all duration-200">Pesan
                    Anda</label>
            </div>

            <button type="submit"
                class="w-full bg-yellow-600 text-white py-4 rounded-lg hover:bg-yellow-700 transition duration-300 font-semibold"
    ...
    <div class="p-8 bg-white rounded-lg shadow-xl hover:shadow-2xl transition duration-300" data-aos="fade-left">
        <h3 class="text-2xl font-bold text-yellow-600 mb-4">Lokasi Kami</h3>
        <iframe
