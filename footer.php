<footer class="bg-purple-500 text-white py-10">
    <div class="container mx-auto px-6 lg:px-20">
        ...
        <!-- Footer Columns -->
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left" data-aos="fade-up">
            <!-- Contact Us -->
            <div>
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm">
                    ...
                    <li><a href="#" class="hover:text-yellow-400">Lokasi</a></li>
                    <li><a href="#" class="hover:text-yellow-400">Kemitraan</a></li>
                    <li><a href="#" class="hover:text-yellow-400">Hubungi Kami</a></li>
                </ul>
            </div>
    ...
    <!-- Bottom Bar -->
    <div class="bg-white py-4 text-center text-sm mt-10" data-aos="fade-up">
        <p class="text-black">&copy; 2024 Webeksplor. All rights reserved. Developed by Webeksplor</p>
    </div>
</footer>
